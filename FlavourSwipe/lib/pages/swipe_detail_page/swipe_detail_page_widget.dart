...
class SwipeDetailPageWidget extends StatefulWidget {
  const SwipeDetailPageWidget({super.key});
                                    ...
                                    Padding(
                                      padding:
                                          const EdgeInsetsDirectional.fromSTEB(
                                              5.0, 5.0, 5.0, 15.0),
                                      child: Text(
                                        'Hallo, ich - eine farbenfrohe und ausgewogene Buddha Bowl - stets bereit, deinen Tag mit meiner bunten Mischung aus frischem Gemüse, Körnern und proteinreichem Tofu zu erhellen. Meine Spezialität? Harmonie in jeder Schicht zu kreieren und dich auf eine kulinarische Reise voller Geschmack und Gesundheit mitzunehmen.',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(
                                              fontFamily: 'Plus Jakarta Sans',
